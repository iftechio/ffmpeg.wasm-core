...
FLAGS=(
  ...
  --enable-muxer=fifo,flv,mp3,mp4,mov,m4v,matroska,ogg,oga,opus,wav,ipod,pcm_f32le
  --enable-demuxer=fifo,flv,mp3,mp4,mov,m4v,matroska,ogg,oga,opus,wav,ipod,aac,pcm_f32le
