...
FLAGS=(
  ...
  --enable-muxer=fifo,flv,mp3,mp4,mov,m4v,matroska,ogg,oga,opus,wav,ipod
  --enable-demuxer=fifo,flv,mp3,mp4,mov,m4v,matroska,ogg,oga,opus,wav,ipod,aac
  --enable-filter=acompressor,acopy,anull,format,aformat,null,transpose,trim,acue,acrossfade,acrossover,adelay,adenorm,aemphasis,afade,afreqshift,aloop,amerge,amix,aresample,asplit,atrim
