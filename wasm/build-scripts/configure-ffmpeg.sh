...
FLAGS=(
  ...
  --enable-filter=acompressor,acopy,anull,format,aformat,null,transpose,trim,acue,acrossfade,acrossover,atempo,adelay,adenorm,loudnorm,aemphasis,afade,afreqshift,aloop,amerge,amix,aresample,arnndn,asplit,atrim
