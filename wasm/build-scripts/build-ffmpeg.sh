...
FLAGS=(
  ...
  -lavdevice -lavfilter -lavformat -lavcodec -lswresample -lswscale -lavutil -lm -lwavpack -lmp3lame -lfdk-aac -lvorbis -lvorbisenc -lvorbisfile -logg -lz -lopus -pthread
